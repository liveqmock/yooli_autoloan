...
public class SqlMapExecutorDelegate {
    ...
    public Object queryForPaginatedCount(SessionScope sessionScope, String id, Object paramObject) throws SQLException {
        Object object = null;
        MappedStatement ms = getMappedStatement(id);
        Transaction trans = getTransaction(sessionScope);
        boolean autoStart = trans == null;
        ...
        try {
            ...
            StatementScope statementScope = beginStatementScope(sessionScope, ms);
            try {
                object = ms.executeQueryForPaginatedCount(statementScope, trans, paramObject);
            } finally {
                endStatementScope(statementScope);
            }
     ...
     * @author shaq
     */
    public List queryForPaginated(SessionScope sessionScope, String id, Object paramObject) throws SQLException {
        ...
        try {
            ...
            try {
                ...
                int rowStart = paramMap.get("rowStart") == null ? 0 : Integer.parseInt(paramMap.get("rowStart").toString());
//                int rowEnd = paramMap.get("rowEnd") == null ? Integer.MAX_VALUE : Integer.parseInt(paramMap.get("rowEnd").toString());
                int numPerPage = paramMap.get("numPerPage") == null ? Integer.MAX_VALUE : Integer.parseInt(paramMap.get("numPerPage").toString());
                list = ms.executeQueryForPaginated(statementScope, trans, paramObject, rowStart, numPerPage);
            } finally {
                endStatementScope(statementScope);
            }
