...
public class SqlMapClientImpl implements SqlMapClient, ExtendedSqlMapClient {
    ...
    @Override
    public List queryForPaginated(String id, Object paramObject) throws SQLException {
        return getLocalSqlMapSession().queryForPaginated(id, paramObject);
    }
	...
	@Override
	public Object queryForPaginatedCount(String id,Object paramObject) throws SQLException {
		return getLocalSqlMapSession().queryForPaginatedCount(id, paramObject);
	}
