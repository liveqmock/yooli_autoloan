...
public interface SqlMapExecutor {
    ...
    List queryForPaginated(String id, Object parameterObject) throws SQLException;

    Object queryForPaginatedCount(String id, Object parameterObject) throws SQLException;
}
